...
VALUES ('userLast1',
        ...
        'userMiddle1',
        'user@mail.ru',
        '$2a$10$Gh/w43nz5tIk08Mj3XIoXucAXkcxviTkTTauBDc9DazXCsYY1K4yW'), --user
       ('adminLast2',
        'adminFirst2',
        'adminMiddle2',
        'admin@mail.ru',
        '$2a$10$Av8UQiYGiQIXZ7FtsL5H6.nVs4kUoUAbHyKDwIae5YWVjSrKLthRy'), --admin
       ('managlast3',
        'managFirst3',
        'managMiddle3',
        'manager@mail.ru',
...
VALUES ('Order 3914', 'EKB', '2019-01-01', '2019-02-05', 1, false, 100000),
       ('Order 393127', 'EKB', '2019-01-02', '2019-02-06', 2, true, 100000),
       ('Order 39235', 'EKB', '2019-01-03', '2019-02-07', 3, true, 100000),
       ...
       ('Order 39536', 'EKB', '2019-01-07', '2019-02-11', 2, false, 100001);
